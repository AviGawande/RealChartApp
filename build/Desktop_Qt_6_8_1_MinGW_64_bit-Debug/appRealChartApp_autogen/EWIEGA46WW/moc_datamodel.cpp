...
Q_CONSTINIT static const uint qt_meta_data_ZN9DataModelE[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       8,    0,   46,    2, 0x02,    6 /* Public */,
       9,    0,   47,    2, 0x02,    7 /* Public */,
...
Q_CONSTINIT const QMetaObject DataModel::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9DataModelE_t,
        ...
        // method 'startUdpReceiver'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'stopUdpReceiver'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void DataModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->newDataPoint((*reinterpret_cast< std::add_pointer_t<float>>(_a[1]))); break;
        case 1: _t->handleUdpData((*reinterpret_cast< std::add_pointer_t<QList<double>>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<qint64>>(_a[2]))); break;
        case 2: _t->startUdpReceiver(); break;
        case 3: _t->stopUdpReceiver(); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DataModel::*)(float );
            if (_q_method_type _q_method = &DataModel::newDataPoint; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DataModel::newDataPoint(float _t1)
{
